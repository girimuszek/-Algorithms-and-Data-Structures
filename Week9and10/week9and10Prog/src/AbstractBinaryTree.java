...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E> implements BinaryTree<E> {
	...
	private Position<E> findNext(Position<E> p, Iterable<Position<E>> iter){
		boolean elementFound = false;
		for (Position<E> pos : iter) {
			if (elementFound) return pos;
			if (p == pos) elementFound = true;
		}
		return null;
	}
	
	public Position<E> preorderNextRecursive(Position<E> p){
		return findNext(p, preorder());
	}

	public Position<E> postorderNextRecursive(Position<E> p){
		return findNext(p, postorder());
	}
	
	public Position<E> inorderNextRecursive(Position<E> p){
		return findNext(p, inorder());
	}
	/**
